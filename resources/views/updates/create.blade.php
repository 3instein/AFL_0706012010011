...
@section('body')
    <div class="login-form w-100 mt-5">
        ...
        <form action="{{ route('updates.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="form-floating">
                    <input type="text" name="title" class="form-control shadow-none @error('title') is-invalid @enderror"
                        id="title" placeholder="" autocomplete="off" value="{{ old('title') }}" autofocus>
            ...
            <div class="row mb-3">
                <div class="form-floating">
                    <input type="text" name="patch_code"
                        ...
                        placeholder="" autocomplete="off" value="{{ old('patch_code') }}">
            ...
            <button type="submit" class="btn btn-primary mb-5 bg-base-color">Create</button>
        </form>
    </div>
@endsection
